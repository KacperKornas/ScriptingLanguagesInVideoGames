...
main() {
    ...
    read -p "Wybór: " game_mode
    while [[ "$game_mode" != "1" && "$game_mode" != "2" ]]; do
        read -p "Wybierz poprawny tryb gry (1 lub 2): " game_mode
    done
    ...
    while true; do
        ...
        if [[ $(check_win "X") != 0 ]] && [[ $(check_win "O") != 0 ]]; then
